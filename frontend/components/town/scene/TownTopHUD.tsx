    ...
    >
      ...
      <div className="town-top-hud-cluster is-right">
        ...
        >
          ...
          />
          {/* 2026-05-21: nav-my-room hidden from the top bar
              per UX request. Code (NavButton, roomApi.getMine,
              myRoom translations) kept intact so flipping the
              constant below restores the entry without further work. */}
          {false && (
            <NavButton
              testId="nav-my-room"
              icon="🏠"
