...
/**
 * Reference's "today's progress + rotating tip" panel. The progress strip
 * mirrors the goal block previously absorbed by `TasksPanel`; restoring
 * the reference layout puts both into one card here. Tips cycle every
 * 8 s — pure visual feedback; no telemetry yet.
 */
export function SessionInsight({ goal = 4, completed = 3 }: Props = {}) {
