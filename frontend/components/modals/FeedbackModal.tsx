...
/**
 * Feedback modal — 480px compact form (subject + body + submit).
 *
 * Backend endpoint pending: submission currently logs to console and shows
 * a success state. Once `/api/v1/feedback` lands, swap the handler to call
 * the typed endpoint.
 */
export function FeedbackModal({
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    // TODO: wire to backend once /api/v1/feedback exists.
    setState({ kind: "ok" });
  }
