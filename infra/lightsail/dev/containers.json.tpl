{
  ...
  "backend": {
    ...
    "command": ["sh", "-c", "alembic upgrade head && (python /app/scripts/seed-dev-data.py || echo 'seed skipped') && python -m app.worker & exec uvicorn app.main:app --host 0.0.0.0 --port 8000"],
    "ports": {
      "8000": "HTTP"
    },
    "environment": {
